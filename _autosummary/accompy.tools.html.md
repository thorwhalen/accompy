...
* **Parameters:**
  * **score** ([`Score`](accompy.base.html.md#accompy.base.Score)) – Base `Score` (will be transposed per key).
...
* **Parameters:**
  * **score** ([`Score`](accompy.base.html.md#accompy.base.Score)) – A `Score` with chord measures.
