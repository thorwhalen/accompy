...
| [`builtin`](accompy.patterns.builtin.md#module-accompy.patterns.builtin)         | Built-in pattern definitions for all supported styles.   |
|--------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| [`dataclasses`](accompy.patterns.dataclasses.md#module-accompy.patterns.dataclasses) | Pattern data structures for accompaniment generation.    |
