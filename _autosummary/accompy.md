...
* **Return type:**
  [`AccompanimentConfig`](accompy.base.md#accompy.base.AccompanimentConfig)
...
* **Return type:**
  [`Score`](accompy.base.md#accompy.base.Score)
...
* **Parameters:**
  * **chords** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`ChordSequence`](accompy.converters.md#accompy.converters.ChordSequence)) – Chord string or ChordSequence
...
* **Return type:**
  [`MidiData`](accompy.converters.md#accompy.converters.MidiData)
* **Returns:**
  MidiData object
...
* **Return type:**
  [`NoteSequence`](accompy.converters.md#accompy.converters.NoteSequence)
* **Returns:**
...
* **Parameters:**
  * **score** ([`Score`](accompy.base.md#accompy.base.Score)) – A [`Score`](#accompy.Score) with chord measures.
...
* **Parameters:**
  * **score** ([`Score`](accompy.base.md#accompy.base.Score)) – Base [`Score`](#accompy.Score) (will be transposed per key).
  ...
  * **score_to_wav** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`ScoreToWav`](accompy.tools.md#accompy.tools.ScoreToWav)]) – Engine callable.  Defaults to [`mma_score_to_wav()`](#accompy.mma_score_to_wav).
* **Return type:**
...
* **Return type:**
  [`PatternRegistry`](accompy.patterns.md#accompy.patterns.PatternRegistry)
* **Returns:**
...
* **Parameters:**
  ...
  * **sr** ([`int`](https://docs.python.org/3/builtins/functions.html#int)) – Sample rate.
* **Return type:**
  [`ScoreToWav`](accompy.tools.md#accompy.tools.ScoreToWav)
* **Returns:**
...
* **Parameters:**
  * **midi_data** ([`MidiData`](accompy.converters.md#accompy.converters.MidiData)) – MidiData object
...
* **Parameters:**
  * **chords** – Chord input — string (`"| Dm7 | G7 | C^7 |"`), iReal URL,
    [`ChordSequence`](accompy.converters.md#accompy.converters.ChordSequence), [`Score`](accompy.base.md#accompy.base.Score),
...
* **Parameters:**
  * **chords** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`ChordSequence`](accompy.converters.md#accompy.converters.ChordSequence)) – Chord string (e.g., `"| Dm7 | G7 | Cmaj7 |"`) or ChordSequence.
  * **skeleton** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`tuple`](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[`float`](https://docs.python.org/3/builtins/functions.html#float), [`...`](https://docs.python.org/3/builtins/constants.html#Ellipsis)]) – Skeleton key, name, style, or duration tuple.
...
| [`audio_renderers`](accompy.audio_renderers.md#module-accompy.audio_renderers)       | Audio renderers — convert MidiData to AudioData.                                |
|-------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| [`base`](accompy.base.md#module-accompy.base)                             | Core domain models for accompy.                                                 |
| [`chord_parsers`](accompy.chord_parsers.md#module-accompy.chord_parsers)           | Chord sheet parsers — convert various text formats to ChordSequence.            |
| [`chord_resolution`](accompy.chord_resolution.md#module-accompy.chord_resolution)     | Chord symbol to MIDI notes resolution.                                          |
| [`chord_resolvers`](accompy.chord_resolvers.md#module-accompy.chord_resolvers)       | Chord resolvers — convert chord symbols to MIDI note numbers.                   |
| [`converters`](accompy.converters.md#module-accompy.converters)                 | Core types for the chord-to-audio pipeline.                                     |
| [`data_access`](accompy.data_access.md#module-accompy.data_access)               | Per-user data directory management for accompy.                                 |
| [`main`](accompy.main.md#module-accompy.main)                             | Main accompaniment generation module.                                           |
| [`midi_generators`](accompy.midi_generators.md#module-accompy.midi_generators)       | MIDI generators — convert NoteSequence to MidiData.                             |
| [`patterns`](accompy.patterns.md#module-accompy.patterns)                     | Pattern registry and access for accompany patterns.                             |
| [`pipeline`](accompy.pipeline.md#module-accompy.pipeline)                     | High-level pipeline API — one-call chord-to-audio conversion.                   |
| [`protocols`](accompy.protocols.md#module-accompy.protocols)                   | Protocols defining extensibility contracts for accompy.                         |
| [`realtime`](accompy.realtime.md#module-accompy.realtime)                     | Real-time accompaniment support (foundation).                                   |
| [`renderers`](accompy.renderers.md#module-accompy.renderers)                   | MIDI and MMA rendering backends for accompy.                                    |
| [`rendering`](accompy.rendering.md#module-accompy.rendering)                   | High-quality chord rendering pipeline — from chord charts to AI-enhanced audio. |
| [`rhythmic_skeletons`](accompy.rhythmic_skeletons.md#module-accompy.rhythmic_skeletons) | Rhythmic skeletons — duration-only measure patterns for simple accompaniment.   |
| [`setup_utils`](accompy.setup_utils.md#module-accompy.setup_utils)               | Setup and configuration utilities for accompy.                                  |
| [`synthesis`](accompy.synthesis.md#module-accompy.synthesis)                   | Audio synthesis backends for accompy.                                           |
| [`tools`](accompy.tools.md#module-accompy.tools)                           | Tools for generating accompaniment audio from Score objects.                    |
| [`util`](accompy.util.md#module-accompy.util)                             | Utility functions for chord parsing and normalization.                          |
| [`wips`](accompy.wips.md#module-accompy.wips)                             | Backward-compatibility shim — wips modules have moved to accompy top level.     |
