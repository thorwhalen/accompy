...
* **Parameters:**
  * **events** ([`Iterator`](https://docs.python.org/3/library/typing.html#typing.Iterator)[[`MidiEvent`](accompy.base.html.md#accompy.base.MidiEvent)]) – Iterator of MIDI events
  * **config** ([`AccompanimentConfig`](accompy.base.html.md#accompy.base.AccompanimentConfig)) – Rendering configuration (tempo, sample rate, etc.)
* **Return type:**
...
* **Parameters:**
  * **events** ([`Iterator`](https://docs.python.org/3/library/typing.html#typing.Iterator)[[`MidiEvent`](accompy.base.html.md#accompy.base.MidiEvent)]) – Iterator of MIDI events
  * **config** ([`AccompanimentConfig`](accompy.base.html.md#accompy.base.AccompanimentConfig)) – Rendering configuration
