...
* **Parameters:**
  * **cs** ([`ChordSequence`](accompy.converters.html.md#accompy.converters.ChordSequence)) – Chord progression to render
...
* **Parameters:**
  * **md** ([`MidiData`](accompy.converters.html.md#accompy.converters.MidiData)) – MIDI data to render
